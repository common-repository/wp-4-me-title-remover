...
Contributors: Daryl Peterson
Tags: title, page title, post title, hide title, remove title, metaboxes, title remover, title remove, wp 4 me
...
= 1.0.1 =
Lengthen constant to prevent conflicts
